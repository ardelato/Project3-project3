        ...
        <Container fluid>
          <Row>
            <Col xs={12} sm={6}>
              <Card.Img
                className="bigImage"
                src={this.props.location.state.props.image}
              />
            </Col>
                  ...
                  <Row className="centerrow">
                    <Col className="iconDiv">
                      ...
                      >
                        <FavoriteIcon
                          fontSize="large"
                          className="favorite material-icons"
                        />
                      </IconButton>
                      <p>Favorite</p>
                    </Col>
                    <Col className="iconDiv">
                      <IconButton
                        ...
                        color="secondary"
                        onClick={() =>
                          this.sendEmail(this.props.location.state.props.userid)
                        }
                      >
                        <ContactMailIcon
                          fontSize="large"
                          className="share material-icons"
                        />
                      </IconButton>
                      <p>Contact</p>
                    </Col>
